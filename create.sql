...
create table kabenyk_st.documents(
    ...
    document_number varchar2(16) not null
);
create table kabenyk_st.documents_patients(
    id_patient number,
    id_document number,
    primary key (id_patient, id_document),
    foreign key (id_patient) references kabenyk_st.patients (id_patient),
    foreign key (id_document) references kabenyk_st.documents (id_document)
);
